...
class LR(Model):
    def __init__(self, input_dim=None, output_dim=1, init_path=None, opt_algo='gd', learning_rate=1e-2, l2_weight=0,
        ...
        with self.graph.as_default():
            ...
            self.vars = dlmcd_utils.init_var_map(init_vars, init_path)
            ...
            self.optimizer = dlmcd_utils.get_optimizer(opt_algo, learning_rate, self.loss)
